...
parser.add_argument('-x2t', '--xml2txt', help="change format from xml to txt.", action="store_true")
parser.add_argument('-j2t', '--json2txt', help="change format from json to txt.", action="store_true")
